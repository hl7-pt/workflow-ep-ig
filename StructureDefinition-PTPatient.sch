...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/BirthPlace']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/BirthPlace': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:contact/f:address/f:extension/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:contact/f:address/f:extension/f:value[x]/f:coding 1</sch:title>
    <sch:rule context="f:Patient/f:contact/f:address/f:extension/f:value[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 0">version: maximum cardinality of 'version' is 0</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
