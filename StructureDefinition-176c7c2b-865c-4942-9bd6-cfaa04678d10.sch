...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/StructureDefinition/BirthPlace']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/StructureDefinition/BirthPlace': maximum cardinality of 'extension' is 1</sch:assert>
