...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Nationality']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Nationality': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Death']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Death': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:address">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Address']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Address': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 0">type: maximum cardinality of 'type' is 0</sch:assert>
      <sch:assert test="count(f:text) &lt;= 0">text: maximum cardinality of 'text' is 0</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:qualification">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Proficiency']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/Proficiency': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:identifier) &lt;= 0">identifier: maximum cardinality of 'identifier' is 0</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:communication">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/NativeLanguage']) &lt;= 1">extension with URL = 'https://hl7.pt/fhir/patient-visit/StructureDefinition/NativeLanguage': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 0">text: maximum cardinality of 'text' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
